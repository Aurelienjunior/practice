...
const FollowUnfollowApp = () => {
  ...
  return (
    <div className=" w-full flex flex-col gap-5 justify-center items-center h-screen border-y ">
      ...
      <div className=" w-full border-black flex justify-center items-center p-4 flex-row gap-5 overflow-x-scroll ">
        {accountInfos.map((account, index) => (
          <div
            key={index}
            className={`  flex flex-col gap-3 items-center shrink-0 p-3 w-[250px] h-[250px] rounded-4xl `}
          >
